...
// initialState is always stores in key-value pair
const initialState = {
...
// createSlice func takes an object ....                    //initialState, reducers are itself an object
const pasteSlice = createSlice(
  ...
  reducers: {
    addToPastes: (state, action) => {
      ...
      // Update to localstorage         //we are storing the state by stringify thus we have to prase it while getting.
